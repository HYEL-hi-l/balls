...
// MARK: Setup
extension FSBlockNode {
    
    private func setupPhysics(size: CGSize) {
        physicsBody = SKPhysicsBody(rectangleOf: size, center: .zero)
        physicsBody?.isDynamic = false
        physicsBody?.categoryBitMask = FSPhysicsCategory.Block
        physicsBody?.collisionBitMask = FSPhysicsCategory.Ball
...
extension FSBlockNode {
    ...
    private func updateAppearance() {
        ...
        strokeColor = fillColor.fruitShootDarker()
